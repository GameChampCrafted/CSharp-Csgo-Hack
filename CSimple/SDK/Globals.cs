...
namespace CSimple.SDK
{
    ...
    class Globals
    {
        public static bool BotEnable = false;
        public static bool VisualsEnable = false;
        public static bool MiscEnable = false;

        public static bool BunnyhopEnable = false;
        public static bool BunnyhopAlwaysOn = false;
        public static int BunnyKey;
        ...
        public static bool bTrigger = false;
        public static bool autoFire = false;
        public static int Delay = 1;


        public static int iTriggerKey;
        public static int iFov = 90;

        public static int iGlowEspKey;
        public static int iTriggerToggleKey;
        public static int iRadarKey;
        public static int iNoFlashKey;

        public static bool bEnemyVis = false;
        public static bool bTeammatesVis = false;
    }
}
